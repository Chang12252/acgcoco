package com.szhc.acgcoco.base.util.wechat;


import com.szhc.acgcoco.base.util.wechat.config.IWXPayDomain;
import com.szhc.acgcoco.base.util.wechat.config.WXRequestConfig;
...
public class WXPayRequest {
    ...
    //想调用发送请求接口
    //new WXPayRequest时要初始化WXPayConfig对象
    private WXRequestConfig config;
    public WXPayRequest(WXRequestConfig config) throws Exception{
        this.config = config;
    }
    ...
    private String request(String urlSuffix, String uuid, String data, int connectTimeoutMs, int readTimeoutMs, boolean useCert, boolean autoReport) throws Exception {
        ...
        if(domainInfo == null){
            throw new Exception("WXRequestConfig.getWXPayDomain().getDomain() is empty or null");
        }
        try {
