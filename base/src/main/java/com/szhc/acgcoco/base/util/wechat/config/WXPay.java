...
import com.szhc.acgcoco.base.util.wechat.WXPayRequest;
...
public class WXPay {
    ...
    private WXRequestConfig config;
    ...
    public WXPay(final WXRequestConfig config) throws Exception {
        this(config, null, true, false);
    }

    public WXPay(final WXRequestConfig config, final boolean autoReport) throws Exception {
        this(config, null, autoReport, false);
    }


    public WXPay(final WXRequestConfig config, final boolean autoReport, final boolean useSandbox) throws Exception{
        this(config, null, autoReport, useSandbox);
    }

    public WXPay(final WXRequestConfig config, final String notifyUrl) throws Exception {
        this(config, notifyUrl, true, false);
    }

    public WXPay(final WXRequestConfig config, final String notifyUrl, final boolean autoReport) throws Exception {
        this(config, notifyUrl, autoReport, false);
    }

    public WXPay(final WXRequestConfig config, final String notifyUrl, final boolean autoReport, final boolean useSandbox) throws Exception {
        this.config = config;
