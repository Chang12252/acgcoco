...
public class StsUtil {
    ...
    private static final String accessKeyId = "LTAI4G9hB2QfpgPdsrQ2tYEm";
    private static final String accessKeySecret = "CGu2oRPSZAkCpGkZTwBGd5eyRcWfEu";
    ...
    public static Map<String,String> getStsMessage(String roleSessionName)  {
        ...
        try {
            response = assumeRole(accessKeyId, accessKeySecret,"acs:ram::1111171279331532:role/zjapp-ram", roleSessionName, policy, protocolType);
