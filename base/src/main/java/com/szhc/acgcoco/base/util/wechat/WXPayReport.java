...
import com.szhc.acgcoco.base.util.wechat.config.WXPayConstants;
...
public class WXPayReport {
    ...
    private WXPayReport(final WXRequestConfig config) {
        this.config = config;
     ...
     * @return
     */
    public static WXPayReport getInstance(WXRequestConfig config) {
        if (INSTANCE == null) {
